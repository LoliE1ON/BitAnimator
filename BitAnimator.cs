...
namespace AudioVisualization
{
    ...
    public class BitAnimator : MonoBehaviour
    {
        ...
        public class RecordSlot
        {
            ...
            public int endFreq;
            public UnityEngine.Vector4 minValue, maxValue;
        ...
        public void Setup()
        {
            computeShader = Resources.Load<ComputeShader>("BitAnimatorKernels");
        ...
        public struct Task
        {
            ...
            public UnityEngine.Vector4 min;
            public UnityEngine.Vector4 max;
            public int channelMask;
            ...
            public void SetRemapCurve(UnityEngine.Vector4 min, UnityEngine.Vector4 max, AnimationCurve curve, int mask)
            {
        ...
        public class TransformBind : RuntimeBinding
        {
            ...
            public override void EvaluatePropertyValue(float value)
            {
                ...
                {
                    case Field.Position:
                        target.transform.localPosition = UnityEngine.Vector3.LerpUnclamped(min, max, value); break;
                    case Field.Rotation:
                        target.transform.localRotation = UnityEngine.Quaternion.Euler(UnityEngine.Vector3.LerpUnclamped(min, max, value)); break;
                    case Field.Scale:
                        target.transform.localScale = UnityEngine.Vector3.LerpUnclamped(min, max, value); break;
                }
            }
        }
